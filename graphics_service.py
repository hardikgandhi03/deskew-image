...
class GraphicsService():
    ...
    def renderPdfDocumentPageToImageFromPath(self, pdfDocPath: str, pageNumber: int, dpi: int) -> str:
        ...
        pageImagePaths = pdf2image.convert_from_path(pdfDocPath, dpi=dpi,poppler_path = r"C:\python-packages\poppler-21.11.0\Library\bin", output_folder=tempFolder, fmt='png', paths_only=True, thread_count=1, first_page=pageNumber, last_page=pageNumber)
